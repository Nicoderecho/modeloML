...
browser = webdriver.Chrome(ChromeDriverManager().install(), options=options)    # Instalar y usar ChromeDriver automáticamente
...
while pagenumber <= 63:    # Will stop scraping once page 63 ends. Page 64 will need to be manually added.
            ...
            while individual <= int(
                ...
                df.loc[-1] = {'Name': browser.find_element(By.XPATH, '//*[@id="content"]/div/div/div[2]/div[1]/h2').text,
                              ...
                              'Owner': browser.find_element(By.XPATH,
                                  '//*[@id="content"]/div/div/section/div/div/table/tbody/tr[' + str(individual) + ']/td[3]').text,
                              'Ticker': browser.find_element(By.XPATH,
                                  '//*[@id="content"]/div/div/section/div/div/table/tbody/tr[' + str(individual) + ']/td[4]').text,
                              'Asset Name': browser.find_element(By.XPATH,
                                  '//*[@id="content"]/div/div/section/div/div/table/tbody/tr[' + str(individual) + ']/td[5]').text,
                              'Asset Type': browser.find_element(By.XPATH,
                                  '//*[@id="content"]/div/div/section/div/div/table/tbody/tr[' + str(individual) + ']/td[6]').text,
                              'Type': browser.find_element(By.XPATH,
                                  '//*[@id="content"]/div/div/section/div/div/table/tbody/tr[' + str(individual) + ']/td[7]').text,
                              'Amount': browser.find_element(By.XPATH,
                                  '//*[@id="content"]/div/div/section/div/div/table/tbody/tr[' + str(individual) + ']/td[8]').text,
                              'Comment': browser.find_element(By.XPATH,
                                  '//*[@id="content"]/div/div/section/div/div/table/tbody/tr[' + str(individual) + ']/td[9]').text
                              }
